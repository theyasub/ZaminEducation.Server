...
namespace ZaminEducation.Data.Migrations
{
    public partial class ZCApplicantMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
<<<<<<<< HEAD:src/ZaminEducation.Data/Migrations/20221006104124_InitialMigration.cs
========
            ...
            migrationBuilder.CreateTable(
>>>>>>>> 817a090bb08bc760e67a10aa78ec7bb8850efd63:src/ZaminEducation.Data/Migrations/20221007012313_ZCApplicantMigration.cs
                name: "QuizAssets",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
...
========
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZCApplicantAssets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ZCApplicantAssets_Attachments_FileId",
                        column: x => x.FileId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ZCApplicantAssets_ZCApplicants_UserId",
                        column: x => x.UserId,
...
>>>>>>>> 817a090bb08bc760e67a10aa78ec7bb8850efd63:src/ZaminEducation.Data/Migrations/20221007012313_ZCApplicantMigration.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZCApplicantAssets_FileId",
                table: "ZCApplicantAssets",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_ZCApplicantAssets_UserId",
                table: "ZCApplicantAssets",
                column: "UserId");
